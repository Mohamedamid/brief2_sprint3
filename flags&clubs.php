            ...
            <div class="content">
                <div class="dashboard-stats">
                    ...
                    <form action="./php/ajouter_flags&clubs.php" method="POST" class="mb-4">
                        <div class="mb-3">
                            <input type="text" name="nom_flag" class="form-control" placeholder="Nom de flag" required>
                        </div>
                        <div class="mb-3">
                            <input type="text" name="url_flag" class="form-control" placeholder="Url de flag" required>
                        </div>
                            ...
                            <tbody>
                                <?php foreach ($result_flags as $flag) { ?>
                                    <tr>
                                        ...
                                        <td class="action">
                                            <a href="./php/update_flags.php?id_flag=<?php echo $flag['id_flag']; ?>" class="btn btn-warning btn-sm">
                                                <i class="fa-solid fa-pen-to-square"></i> Edit
                                            </a> 
                                            <a href="./php/deletclub&flag.php?id_flag=<?php echo $flag['id_flag']; ?>" class="btn btn-danger btn-sm">
                            ...
                            <tbody>
                                <?php foreach ($result_clubs as $club) { ?>
                                    <tr>
                                        ...
                                        <td class="action">
                                            <a href="./php/update_clubs.php?id_club=<?php echo $club['id_club']; ?>" class="btn btn-warning btn-sm">
                                                <i class="fa-solid fa-pen-to-square"></i> Edit
                                            </a> 
                                            <a href="./php/deletclub&flag.php?id_club=<?php echo $club['id_club']; ?>" class="btn btn-danger btn-sm">
                                                <i class="fa-solid fa-trash"></i> Delete
                                            </a>
                                        </td>
                                    </tr>
